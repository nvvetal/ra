...
// medals awarding
	...
	'MEDAL_AWARD_GOOD'				=> 'Medal awarded successfully!<br /><br /><a href="%s">Return to the previous page</a>',
	'NOT_MEDALS_AWARDED'			=> 'Medal could not be awarded to the following user(s):<br />%s<br /><br /><a href="%s">Return to the previous page</a>',
	'MEDAL_REMOVE_GOOD'				=> 'Medal removed successfully!<br /><br /><a href="%s">Return to the previous page</a>',
	'MEDAL_EDIT'					=> 'Edit',
...
// medals nominate
	...
	'MEDAL_NOMINATE_GOOD'			=> 'Medal nominated successfully!<br /><br /><a href="%s">Return to the previous page</a>',
	...
	'NOMINATIONS_REMOVE_GOOD'		=> 'Nominations removed successfully!<br /><br /><a href="%s">Return to the previous page</a>',
...
// Error messages
	'CANNOT_AWARD_MULTIPLE'			=> 'This user has been awarded the maximum number of medals available.<br /><br /><a href="%s">Return to the previous page</a>',
	...
	'NO_MEDAL_ID'					=> 'No Medal ID was specified',
