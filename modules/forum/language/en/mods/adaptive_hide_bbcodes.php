...
$lang = array_merge($lang, array(
	...
	'ADAPT_HIDE_GUEST_POSTS'	=>	'<i>Hidden text. You should register and have %d post(s)</i>',
	'ADAPT_HIDE_POSTS'			=>	'<i>Hidden text. You should have %d post(s).</i>',
	'ADAPT_HIDE_GROUPS'			=>	'<i>Hidden text. You do not consist in groups, to which this text is accessible.</i>',
