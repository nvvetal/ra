          ...
          <!-- BEGIN switch_poll_choice_toggle -->
          <tr>
        <td class="row1"><span class="gen"><b>{L_POLL_CHOICE}</b></span></td>
        <td class="row2"><span class="gen">{S_POLL_CHOICE_TOGGLE}</td>
          </tr>
          <!-- END switch_poll_choice_toggle -->	        
            <tr>
