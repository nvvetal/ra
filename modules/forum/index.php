...
$template->assign_vars(array(
        ...
        'RAKS_FACEBOOK_ID' => RAKS_FACEBOOK_ID,
        'RAKS_FACEBOOK_VERSION' => RAKS_FACEBOOK_VERSION,
    )
);

sendRaksMoney($user->data['user_id'], 'forumEnter');
sendRaksMoney($user->data['user_id'], 'forumEnterDaily');
// Output page
