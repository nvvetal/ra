...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadBanners()
        {
            ...
            banner_165_3[1]   = new Array ('<a href="http://raks.com.ua/forum/viewtopic.php?f=148&t=16398" target="_blank"><img src="http://raks.com.ua/forum/images/diva.jpg" alt=""/></a>', 'html', 165, 190);
