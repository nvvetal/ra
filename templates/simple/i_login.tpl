...
<script>
    ...
    $(document).ready(function(){
        $('#fb').click(function(){
            var url = 'https://www.facebook.com/{/literal}{$facebook_version}{literal}/dialog/oauth?client_id={/literal}{$facebook_app_id}{literal}&redirect_uri='+encodeURI('https://raks.com.ua')+'&state='+encodeURI('go=index,action=facebook')+'&scope={/literal}{$facebook_login_scope}{literal}&response_type=code%20token';
            console.log('[URL]', url);
