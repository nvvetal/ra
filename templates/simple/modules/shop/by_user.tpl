...
'<hr/>'+
'<div>'+
    '<span style="color:red">{"user gifts count"|i18n} {$goods.cnt}</span>&nbsp;&nbsp;<a href="{$http_project_path}?go=my_profile">{"gift all list"|i18n}</a>&nbsp;&nbsp;<a href="{$http_project_path}shop/">{"send gift to somebody"|i18n}</a></div>'+
    '<div>'+
