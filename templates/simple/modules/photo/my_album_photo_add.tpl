...
{/literal}
<div class="title">{"My Album Photos Add"|i18n} :: {$userAlbum->name}</div>
...
<input type="button" name="btnBack" value="{"Back"|i18n}" onclick="window.location='?go=my_album_photos&s={$s}&album_id={$smarty.request.album_id}'" />			
