...
{foreach name="videoItems" from=$videosData.items item=videoItems}
    {foreach name="video" from=$videoItems item=video}
        ...
        {/if}
        <div style="display: inline; float: left;padding-right:5px;margin-bottom:10px;">
...
<br clear="all"/>
<div id="log"></div>
{include file="i_pager.tpl" request="go|s|album_id" max_page=$videosData.pages useNormalPages=1}
